...
- summary: write a confident, ambitious 2–3 sentence value pitch grounded in the summary evidence and highest-priority experience. Lead with the target role and the candidate's strongest verified differentiator, then connect proven technologies and outcomes to the employer's needs. Avoid generic openings, adjective-led claims, clichés such as "results-driven" or "passionate professional", bare skill lists, and copied job-description language.
Return ONLY JSON:
